...
def validate_data(values):
    ...
    Raises ValueError if strings connot be converted into int, or if there aren't exactly 6 values.
    """
...
#     """
#     Upadta surplus worksheet, add new row with the list data provided.
#     """
